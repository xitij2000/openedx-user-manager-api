...
"""
openedx-user-manager-api documentation build configuration file.
...
project = 'openedx-user-manager-api'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'User Manager API'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     ...
     'an app that provides a API to manager user-manager relashionships in Open edX.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    'django': (
    'https://docs.djangoproject.com/en/1.10/', 'https://docs.djangoproject.com/en/1.10/_objects/'),
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'user_manager'),
                os.path.join(root_path, 'user_manager/migrations')])
