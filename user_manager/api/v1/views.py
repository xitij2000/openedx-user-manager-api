...
class ManagerReportsListView(ListCreateAPIView):
    """
        ...
        **Example GET Response**
            ...
            {
                "count": 99,
                "next": "https://courses.org/api/user_manager/v1/reports/edx@example.com/?page=2",
                "previous": null,
                "results": {
                    {
                        "email": "staff@example.com",
...
class UserManagerListView(ListCreateAPIView):
    """
        ...
        **Example Request**
            ...
            GET /api/user_manager/v1/managers/{user_id}/

            POST /api/user_manager/v1/managers/{user_id}/ {
                "email": "{email}"
            }

            DELETE /api/user_manager/v1/managers/{user_id}/

            DELETE /api/user_manager/v1/managers/{user_id}/?user={user_id}
        ...
        **GET Response Values**
            ...
            * results: a list of managers directly over a user:
                ...
                * id: The user id for a manager (may be null if manager hasn't
        ...
        **Example GET Response**
            ...
            GET /api/user_manager/v1/managers/staff@example.com/

            {
                "count": 99,
                "next": "https://courses.org/api/user_manager/v1/managers/staff@example.com/?page=2",
                "previous": null,
                "results": {
                    {
        ...
        **Example POST Response**
            ...
            POST /api/user_manager/v1/managers/edx@example.com/ {
                "email": "user@email.com"
            }
        ...
        **Example DELETE Response**
            ...
            DELETE /api/user_manager/v1/managers/edx@exmaple.com/

            DELETE /api/user_manager/v1/managers/edx@exmaple.com/?report=some@user.com
    """
